                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="widget about-us">
                                <div class="footer-brand"><span>Re</span>Touch</div>
                        ...
                        <div class="col-md-3">
                            <div class="widget popular-posts">
                                ...
                                <ul class="recent-posts">
                                    <li>
                                        <img src="<?php echo base_url() ?>images/photo (1).jpg" alt="Post Image">
                                        <h5>
                                    ...
                                    <li>
                                        <img src="<?php echo base_url() ?>images/photo (2).jpg" alt="Post Image">
                                        <h5>
                                    ...
                                    <li>
                                        <img src="<?php echo base_url() ?>images/photo (3).jpg" alt="Post Image">
                                        <h5>
