...
<form role="form" class="form-horizontal" action="" method="post" enctype="multipart/form-data">
    <div class="searchingNum">Account Login Details</div>
    ...
    <div class="searchingNum">Password</div>
...
<div class="submitbutton">
    <div class="flbox"><a class="btn btn-danger" href="<?php echo site_url('session/login') ?>">Login</a></div>
