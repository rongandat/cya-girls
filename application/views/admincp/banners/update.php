    ...
    <div class="col-xs-12">
        ...
        <form action="" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
            ...
            <div class="form-group <?php echo!empty($error['name']) ? ' has-error' : '' ?>">
                ...
                <div class="col-sm-9">
                    <input type="text" id="name" name="name" placeholder="Name" value="<?php echo!empty($banner['name']) ? $banner['name'] : '' ?>" class="col-xs-10 col-sm-5" />
                </div>
            ...
            <div class="form-group <?php echo!empty($error['url']) ? ' has-error' : '' ?>">
                ...
                <div class="col-sm-9">
                    <input type="text" id="url" name="url" placeholder="url" value="<?php echo!empty($banner['url']) ? $banner['url'] : '' ?>" class="col-xs-10 col-sm-5" />
                </div>
            ...
            <div class="form-group <?php echo!empty($error['order']) ? ' has-error' : '' ?>">
                ...
                <div class="col-sm-9">
                    <input type="text" id="order" name="order" placeholder="Order" value="<?php echo!empty($banner['order']) ? $banner['order'] : '' ?>" class="col-xs-10 col-sm-5" />
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-10 col-sm-3">
                    <span class="profile-picture">
                        <?php $image = !empty($banner['image']) ? $banner['image'] : ''; ?>
                        <img src="<?php echo base_url() . 'public/images/banners/' . $banner['image'] ?>" alt="" class="editable img-responsive editable-click editable-empty" id="image"></img>
                    </span>
                </div>
            ...
            <?php endif; ?>
            <div class="form-group  <?php echo!empty($error['image']) ? ' has-error' : '' ?>">
                <label class="col-sm-3 control-label no-padding-right" for="image_link"> Or image banner</label>
                <div class="col-sm-9">
                    <input type="text" id="image_link" name="image_link" placeholder="image banner" value="<?php echo!empty($banner['image_link']) ? $banner['image_link'] : '' ?>" class="col-xs-10 col-sm-5" />
                </div>
                <div class="clearfix"></div>
            ...
            <div class="form-group <?php echo!empty($error['status']) ? ' has-error' : '' ?>">
                ...
                <div class="col-sm-9">
                    <input name="status" <?php echo (!isset($banner['status']) || $banner['status'] == 1 ) ? 'checked' : '' ?> class="ace ace-switch" type="checkbox" />
                    <span class="lbl"></span>
                </div>
