...
class Search extends MY_Controller {
    ...
    public function index($id = 0) {
        ...
        $offset = $page;
        $sqlWhere = "status = 1 AND (title LIKE '%{$search}%' OR fullname LIKE '%{$search}%')";
        $girls = $this->girl->listGirls($sqlWhere, array(), 0, '*', $limit, $offset);
        $totalRecord = $this->girl->listGirlTotal($sqlWhere);
